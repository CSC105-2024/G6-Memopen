...
const Sidebar = () => {
  ...
  return (
    <>
      {!isOpen && (
        <button
          className="fixed top-4 left-4  p-2 text-black text-2xl rounded-md md:hidden "
      ...
      <aside
        className={`fixed top-0 left-0 z-50 min-h-screen  w-64 bg-black p-6 flex flex-col items-center transition-transform duration-300 ${
      ...
      >
        ...
        <div className="relative">
          <img
            ...
            alt="Profile"
            className="w-35 h-35 rounded-full border-2 border-gray-300 object-cover mt-5"
          />
