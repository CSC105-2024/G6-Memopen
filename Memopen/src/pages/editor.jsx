...
function Editor(){
    ...
    const[colorPickerClick , setColorPickerClick] = useState(false);
    ...
    useEffect(()=>{ // useEffect run when component load
        ...
        return () =>{  //run when component remove from page 
            window.removeEventListener("keydown", handleKeyDown) //removeEventlistener when navigate to diffrent page
        ...
        <div className="bg-[url('./src/assets/editorAssets/editor_bg.png')] bg-cover bg-center min-h-screen">
            ...
            <div className="editor-nav bg-black flex justify-between items-center px-7 py-5  ">
                ...
                <div className="editor-nav-right flex gap-5">
                    <button className="bg-[#00917C] px-[26px] py-[16px] rounded-[10px] text-white text-3xl cursor-pointer">Dowload</button>
                    <button className="bg-[#00BE33] px-[26px] py-[16px] rounded-[10px] text-white text-3xl cursor-pointer" >Save</button>
                </div>
            </div>
            <div className="area flex justify-center items-center flex-col ">
                <div className="canvas-box flex flex-col my-4 mx-10 max-w-[960px]">
                    <div className="canvas-head bg-black flex items-center p-3 justify-center md:justify-around">
                        <button onClick={addText} className="addtext cursor-pointer  bg-[#D9D9D9] px-[23px] py-[10px] text-2xl rounded-[10px] font-semibold">Add text</button>
                        <div className="font-style flex gap-6 bs">
                            <button><div className="cursor-pointer text-white font-bold text-2xl">B</div></button>
                            <button><div className="cursor-pointer text-white italic text-2xl">I</div></button>
                            <button><div className="cursor-pointer text-white font-bold underline text-2xl">U</div></button>
                        </div>
                        <div className="textcoloredit flex items-center gap-6">
                            <div className="textcolorsection flex items-center gap-3">
                                <label><div className="text-white text-2xl underline font-semibold">A</div></label>
                                <input 
                            ...
                            <div className="texthighlightsection flex items-center gap-3">
                                <label><div><img src="./src/assets/editorAssets/highlight.svg"/></div></label>
                        ...
                        <div className="imgInput flex items-center gap-7">
                                ...
                                <button className="cursor-pointer" onClick={()=> document.getElementById("imageInput").click()}><img src="./src/assets/editorAssets/imgInput.svg"/></button>
                                <input id="imageInput" onChange={addImage} className="hidden " type="file" accept="image/*"/>
                        </div>
                    </div>
                ...
                <div className="addTagBox rounded-[15px] bg-white w-[960px] px-10 py-3 flex gap-10 items-center">
                    ...
                    <div className="editor-tag-input flex gap-3 items-center">
                        <input className="w-10 h-10 rounded-full cursor-pointer border-none p-0 " type="color"/>
                        <input className="border border-black rounded-[20px] px-2.5 py-3.5 bg-white w-[700px] overflow-clip" type="text" placeholder="Enter new tag" />
                    </div>
                </div>
